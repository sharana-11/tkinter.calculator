...
button_eq=Button(root,text='=',padx=40,pady=20,command= button_eq)
button_clr=Button(root,text='clear',padx=125,pady=20,command= button_clear)
...
button_eq.grid(row=5,column=0)
button_clr.grid(row=6,column=0,columnspan=6)
